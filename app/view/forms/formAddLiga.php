...
<div class="py-5">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form method="post"  action="LigaController.php?rota=cadastrar" enctype="multipart/form-data" class="w-50 mx-auto">
                    <div class="form-group">
                        <label>Nome</label>
                        <input type="text" class="form-control" placeholder="Nome da Liga" name="nome"> </div>
                    <div class="form-group">
                        <label>Historia</label>
                        <input type="text" class="form-control" placeholder="Historia da Liga" name="historia"> </div>
                    <div class="form-group">
                        <label>Funcação</label>
                        <input type="text" class="form-control" placeholder="Fundacao" name="fundacao"> </div>
                    <div class="form-group">
                        <label>Regras</label>
                        <input type="text" class="form-control" placeholder="Regulamento" name="regulamento"> </div>
                    <div class="form-group">
                        <label>País</label>
                        <input type="text" class="form-control" placeholder="País" name="pais"> </div>
                    <div class="form-group">
