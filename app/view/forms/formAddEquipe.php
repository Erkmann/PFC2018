...
<div class="py-5">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form method="post"  action="TimeController.php?rota=cadastrar" enctype="multipart/form-data" class="w-50 mx-auto">
                    <div class="form-group">
                        <label>Nome</label>
                        <input type="text" class="form-control" placeholder="Nome da Equipe" name="nome"> </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Numero de Torcedores" name="num_torcedores"> </div>
                    <div class="form-group">
                        <label>Títulos</label>
                        <input type="text" class="form-control" placeholder="Titulos" name="titulos"> </div>
                    <div class="form-group">
