<nav class="navbar navbar-expand-md navbar-dark bg-secondary">
    <div class="container">
        <a class="navbar-brand" href="HomeController.php">TCC</a>
        ...
        <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0"> <input class="form-control mr-sm-2 form-control-sm w-50 mx-1" type="text" placeholder="Pesquise"> <button class="btn my-2 my-sm-0 btn-outline-success" type="submit">Search</button> </form>
