...
<div class="cabecalho text-center py-5">
    <div class="container">
        <div class="row my-5 justify-content-center">
            <div class="col-md-10">
                <p class="lead text-dark">Abaixo, você encontra algumas sugestões de jogadores que podem-lhe interessar!</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table">
                    ...
                    <tbody>
                    <?php foreach ($craques as $c):?>
                        <tr>
                            <td><a href="../controller/CraqueController.php?rota=ver&id=<?= $c->getIdCraque();?>"><?= $c->getNomeCraque();?></a></td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
                </table>
